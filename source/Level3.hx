...
class Level3 extends FlxState
{
	...
	override public function create()
	{
		...
		// block stuff
		block = new FlxSprite(400, 0).loadGraphic(Paths.image('blocks/block'));
		FlxTween.tween(block, {y: block.y + 680}, 1.3, {type: FlxTween.PINGPONG, ease: FlxEase.cubeInOut, startDelay: 0});
		block.immovable = true;
		add(block);

		block2 = new FlxSprite(500, 0).loadGraphic(Paths.image('blocks/block'));
		FlxTween.tween(block2, {y: block2.y + 680}, 1.3, {type: FlxTween.PINGPONG, ease: FlxEase.cubeInOut, startDelay: 0.2});
		block2.immovable = true;
		add(block2);

		block3 = new FlxSprite(600, 0).loadGraphic(Paths.image('blocks/block'));
		FlxTween.tween(block3, {y: block3.y + 680}, 1.3, {type: FlxTween.PINGPONG, ease: FlxEase.cubeInOut, startDelay: 0.4});
		block3.immovable = true;
		add(block3);

		block4 = new FlxSprite(700, 0).loadGraphic(Paths.image('blocks/block'));
		FlxTween.tween(block4, {y: block4.y + 680}, 1.3, {type: FlxTween.PINGPONG, ease: FlxEase.cubeInOut, startDelay: 0.6});
		block4.immovable = true;
		add(block4);

		block5 = new FlxSprite(800, 0).loadGraphic(Paths.image('blocks/block'));
		FlxTween.tween(block5, {y: block5.y + 680}, 1.3, {type: FlxTween.PINGPONG, ease: FlxEase.cubeInOut, startDelay: 0.8});
		block5.immovable = true;
		add(block5);

		endblock = new FlxSprite(1000, 250).loadGraphic(Paths.image('blocks/levelend'));
		endblock.immovable = true;
		FlxTween.tween(endblock, {y: endblock.y + 100}, 3, {type: FlxTween.PINGPONG, ease: FlxEase.cubeInOut});
		add(endblock);
