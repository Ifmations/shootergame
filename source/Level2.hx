...
class Level2 extends FlxState
{
	...
	override public function create()
	{
		...
		fakemoveblock2 = new FlxSprite(900, 300).loadGraphic(Paths.image('blocks/move'));
		add(fakemoveblock2);

		coinmoveblock = new FlxSprite(900, 550).loadGraphic(Paths.image('blocks/move'));
		...
		var blockrandom:Int = FlxG.random.int(0, 1);
		switch (blockrandom)
		{
			case 0:
				moveblock.y = 50;
