...
class Level1 extends FlxState
{
	...
	override public function create()
	{
		...
		// block stuff
		block = new FlxSprite(700, 85).loadGraphic(Paths.image('blocks/block'));
		block.immovable = true;
		add(block);

		block2 = new FlxSprite(700, 650).loadGraphic(Paths.image('blocks/block'));
		block2.immovable = true;
		add(block2);

		block3 = new FlxSprite(700, 560).loadGraphic(Paths.image('blocks/block'));
		block3.immovable = true;
		add(block3);

		block4 = new FlxSprite(700, 480).loadGraphic(Paths.image('blocks/block'));
		block4.immovable = true;
		add(block4);

		block5 = new FlxSprite(700, 395).loadGraphic(Paths.image('blocks/block'));
		block5.immovable = true;
		add(block5);

		bounceblock = new FlxSprite(700, 175).loadGraphic(Paths.image('blocks/rebound'));
		...
		moveblock2 = new FlxSprite(700, 0).loadGraphic(Paths.image('blocks/move'));
